...
MIN_TOGETHER_CATEGORIES = 10  # минимум совместных покупок для пар категорий
LIFT_FLOOR = 1.0  # рекомендуем только пары с lift > LIFT_FLOOR (связь сильнее случайной, этап 4)
